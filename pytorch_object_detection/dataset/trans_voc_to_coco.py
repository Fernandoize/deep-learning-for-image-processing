...
val_files_num = 100
test_files_num = 100
voc_annotations = '/Users/wangfengguo/LocalTools/data/DUODataSet/VOCdevkit/VOC2012/Annotations/'  # remember to modify the path
...
def convert(xml_files, json_file, image_id):
...
convert(xml_val_files, coco_json_annotations + 'val2017.json', image_id)
convert(xml_test_files, coco_json_annotations + 'test2017.json', image_id)
convert(xml_train_files, coco_json_annotations + 'train2017.json', image_id)