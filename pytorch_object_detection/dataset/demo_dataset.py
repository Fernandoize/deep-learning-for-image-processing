...
from faster_rcnn.draw_box_utils import draw_objs
...
if __name__ == '__main__':
    ...
    # read class_indict
    category_index = {}
    class_file_path = "./urpc_classes.json"
    try:
    ...
    # load train data set
    train_data_set = VOCDataSet(SRC_ROOT, "2012", data_transform["train"], "train.txt")
